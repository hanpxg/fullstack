...
import com.ibm.w3.feign.SecurityFeignClient;
...
public class PreFilter extends ZuulFilter {
	...
	public int filterOrder() {
	  ...
	  public boolean shouldFilter() {
		...
		if (request.getRequestURI().indexOf(DOWNLOAD) >= 0 ||
				request.getRequestURI().indexOf(LOGIN_URI) >= 0 ||
				request.getRequestURI().indexOf(SIGNUP_URI) >= 0 ||
